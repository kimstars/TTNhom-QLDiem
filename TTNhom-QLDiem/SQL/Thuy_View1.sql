...
select hv.MaHocVien, hv.HoTenHV, hp.TenHocPhan, ctpd.DiemCC, ctpd.DiemTX, ctpd.DiemThi, ctpd.DiemTK, gv.HoTenGV, hk.TenHocKy, hk.MaHocKy, gv.MaGiangVien, hp.MaHocPhan, lhp.MaLopHocPhan, ctpd.MaChiTietPhieuDiem, ctpd.MaPhieuDiem from HocVien hv
